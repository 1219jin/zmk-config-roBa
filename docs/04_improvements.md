...
| 2026/06/06 | Ctrl+W(Win)/Cmd+W(Mac)コンボをW+O(1+8)に再設計・復元（⑯中間） | 3326dea |
| 2026/06/06 | close_win/macをM+.(30+32)に再調整。右手完結・mouseレイヤーMB1/MB2/MB3と無干渉・母音キー回避（⑯完了） | PLACEHOLDER |
